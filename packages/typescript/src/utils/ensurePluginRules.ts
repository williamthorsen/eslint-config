 ...
 * the rules run correctly under ESLint 10. Because the `LooseRuleDefinition` parameter keeps the input
 * rule-shaped (each value must expose a `create` function), the assertion narrows only the `RuleContext`
 * axis.
 */
