...
// `['.js', '.mjs', '.cjs']`; without it, every rule that walks the module graph would be inert on a TypeScript source.
// This is the `import-x/extensions` setting, unrelated to the rule of the same name below.
// The list mirrors `patterns.codeExtensions`.
const settings = {
